...
def main():
    ...
    sheepPolicy = stationaryAgentPolicy # static sheep 
    ...
    # wolf policy from algorithm, e.g., QLearning, dqn, ddpg
    # here randomPolicy just for demo
    #wolfPolicy = QLearning
    #wolfPolicy = ActorNetWorkAfterTrainFromActor-Critic
    wolfSpeedRatio = 60 
    wolfActionSpace = list(map(tuple, np.array(actionDirections) * wolfSpeedRatio))
    wolfPolicy = RandomPolicy(wolfActionSpace)
    ...
    parametersForTrajectoryPath = {'algorithmAgentId': wolfId}
