...
from src.MDPChasing.transitionFunction import IsInObstacleSingleState, IsTerminalSingleState
...
class TestReward(unittest.TestCase):
	def setUp(self):
		...
		self.isInObstacle = IsInObstacleSingleState(self.Obstacle)
		self.minDistance = 10
		self.TerminalPosition = [500, 500]
		self.isTerminal = IsTerminalSingleState(self.minDistance, self.TerminalPosition)
